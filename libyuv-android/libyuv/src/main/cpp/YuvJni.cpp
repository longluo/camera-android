...
Java_com_libyuv_util_YuvUtil_init(JNIEnv
                                  *env,
                                  jclass type, jint
                                  width,
                                  jint height, jint
...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_compressYUV(JNIEnv
                                         *env,
                                         jclass type,
                                         jbyteArray
                                         src_,
...
//因为旋转的角度都是90和270，那后面的数据width和height是相反的
    ...
    env->
            ReleaseByteArrayElements(dst_, Dst_data,
                                     0);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_cropYUV(JNIEnv
                                     *env,
...
//left和top必须为偶数，否则显示会有问题
    ...
    env->
            ReleaseByteArrayElements(dst_, dst_i420_data,
                                     0);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_yuvI420ToNV21(JNIEnv
                                           *env,
                                           jclass type, jbyteArray
                                           i420Src,
                                           jbyteArray nv21Src,
