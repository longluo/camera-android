...
public class CameraUtils {
    ...
    private int setCameraDisplayOrientation(int cameraId) {
        ...
        int rotation = DemoApplication.getCurrentActivity().getWindowManager().getDefaultDisplay().getRotation();
        int degrees = 0;
        switch (rotation) {
    ...
    public void openCamera(int cameraType) {
        ...
        SPUtils.put(Contacts.CAMERA_Morientation, morientation);
        ...
        SPUtils.put(Contacts.CAMERA_WIDTH, cameraWidth);
        SPUtils.put(Contacts.CAMERA_HEIGHT, cameraHeight);
    }
