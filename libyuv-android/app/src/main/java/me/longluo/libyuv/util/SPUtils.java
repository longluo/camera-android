package me.longluo.libyuv.util;
...
public class SPUtils {
    ...
    public static void put(String key, Object object) {
        put(DemoApplication.getInstance(), FILE_NAME, key, object);
    }
    ...
    public static Object get(String key, Object defaultObject) {
        return get(DemoApplication.getInstance(), FILE_NAME, key, defaultObject);
    }
    ...
    public static void remove(String key) {
        remove(DemoApplication.getInstance(), FILE_NAME, key);
    }
    ...
    public static void clear() {
        clear(DemoApplication.getInstance(), FILE_NAME);
    }
    ...
    public static boolean contains(String key) {
        return contains(DemoApplication.getInstance(), FILE_NAME, key);
    }
    ...
    public static Map<String, ?> getAll() {
        return getAll(DemoApplication.getInstance(), FILE_NAME);
    }
